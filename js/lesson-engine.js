...
import { lessonFor, allLessons } from "./lessons/lesson-catalog.js?v=20260910-ch6-mcq-show-1";
import { normalizeAllowedFavoriteColor } from "./mcq-audio-config.js?v=20260910-ch6-mcq-show-1";
import {
  buildPartReporting,
  normalizeIdList,
  PROGRESS_CONTRACT_VERSION,
} from "./progress-contract.js?v=20260910-ch6-mcq-show-1";
...
function emitBadgeAwardsIfNeeded(lessonId = ACTIVE_LESSON_ID, levelId = ACTIVE_LEVEL_ID) {
  ...
  import("./badge-engine.js?v=20260910-ch6-mcq-show-1")
    .then((m) => {
