...
import { lessonFor, allLessons } from "./lessons/lesson-catalog.js?v=20260910-ch6-mcq-show-2";
import { normalizeAllowedFavoriteColor } from "./mcq-audio-config.js?v=20260910-ch6-mcq-show-2";
import {
  buildPartReporting,
  normalizeIdList,
